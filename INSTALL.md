...
## Install Pytorch for python 2.7
Clone the repository in the pytroch install page below, or type the following command lines.
...
Pytorch install page : [click here](https://pytorch.org)
...
For basic image augmentation, the following must be installed within your environment.
- [OpenCV]()
- [PIL Image]()
